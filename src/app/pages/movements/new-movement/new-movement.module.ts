...
import { UserManualAccountsComponent } from './user-manual-accounts/user-manual-accounts.component';

@NgModule({
	declarations: [ NewMovementComponent, UserManualAccountsComponent ],
	imports: [ NEW_MOVEMENT_ROUTER, SharedModule, DateModule, TypeModule, BackButtonModule ],
